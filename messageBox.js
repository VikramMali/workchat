class MessageBox extends HTMLElement {
    constructor() {
        ...
        <div class="row message">
          <img class="img" src="" alt="">
            ...
            <div class="row message-zone">
              <div class="row message-name-time message-sender-name-time">
              ...
              <span class="message-time "></span>
                ...
                <div class="message-toolbar-container">
                        <div class="message-toolbar">
                            ...
                            <svg  class="thread-open" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <svg class="three-dots" tabindex="0" xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <div class="message-options">
                                ...
                                <div class="row message-options-elements">
                                    ...
                                    <span class="thread-open">Thread</span>
                                </div>
                                <div class="row message-options-elements">
        ...
        const threadOpenButton = this.shadowRoot.querySelector(".thread-open");
        ...
        threadOpenButton.addEventListener("click", () => {
    ...
    setMessageData(data) {
        ...
        const contextMenu = shadowRoot.querySelector(".message-zone");
        ...
        if (data.owner === "You") {
            ...
            contextMenu.classList.add("sender-zone");
        } else {
            messageContainer.classList.add("receiver");
            textElement.classList.add("receiver-text");
            contextMenu.classList.add("receiver-zone");
        }
    }
}
